...
- Stroke hierarchy: outer rings faint (`rgba(..,0.30–0.45)`), progressing to muted, to ink, to gold at the innermost focal.
...
- Italic Cormorant Garamond callouts (see `references/primitive-annotation.md`) — 1–2 max.
...
- Gold on multiple levels — hierarchy collapses.
