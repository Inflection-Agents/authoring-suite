...
<polyline points="x0,y0 x1,y1 x2,y2 ..."
          fill="none" stroke="var(--dd-accent)" stroke-width="1.8" stroke-linejoin="round"/>
<!-- Dots at each point (focal only) -->
<circle cx="x0" cy="y0" r="4" fill="var(--dd-accent)"/>

<!-- Non-focal series -->
<polyline points="x0,y0 x1,y1 ..."
          fill="none" stroke="var(--dd-series-1)" stroke-width="1.2" stroke-linejoin="round"/>
```
