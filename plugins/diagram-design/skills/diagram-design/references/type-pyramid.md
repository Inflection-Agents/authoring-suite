...
- Each layer has:
  - **Name label** centered inside the trapezoid — DM Sans 12–14px 600.
...
- **Gold on ONE layer only**: apex of pyramid, conversion layer of funnel, or critical bottleneck.
...
- Gold on the base layer (dilutes the "apex = rare" signal).
