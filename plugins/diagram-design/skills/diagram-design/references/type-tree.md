...
- Nodes are small labeled rectangles (`rx=6`), DM Sans 12px 600 name + optional Geist Mono 9px sublabel. Width 120–180px, height 40–52px.
...
- Gold on **one** node: root OR critical leaf. Not both.
