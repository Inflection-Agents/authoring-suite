...
|---|---|---|---|
| Title (Cormorant Garamond) | 28 | 40 | 32 |
| Node name (DM Sans 600) | 12 | 16 | 12 |
...
DM Sans has no CJK coverage. When labels contain Japanese, Chinese, or Korean text, extend the family on those `<text>` elements — don't swap the whole skin:

```svg
<text font-family="'DM Sans', 'Hiragino Sans', 'Noto Sans JP', 'Yu Gothic', sans-serif">認証サービス</text>
```
