...
## Layout conventions
- Root owner or front door at top center. Use one gold focal node for the person/team/agent that receives ambiguous work.
...
- Each node should answer three questions when space allows:
  1. **Name** — human-readable role/person/agent in DM Sans sans.
...
- Max gold nodes: 1. The org chart's job is clarity, not highlighting everything.
- Max side callouts: 2.
