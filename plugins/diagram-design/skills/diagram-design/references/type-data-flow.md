...
| Code | Color | Meaning |
|------|-------|---------|
| `WB` | `var(--dd-series-5)` (mauve) | Web / Public data |
| `DB` | `var(--dd-series-2)` (steel-blue) | Dataset / Raw file |
| `TB` | `var(--dd-series-3)` (amber) | Table / Analysis-ready |
| `FL` | `var(--dd-series-4)` (sienna) | File / Report / Export |
