...
| --- | --- | --- | --- | --- | --- | --- |
| `standard` | `var(--dd-node-white)` | `ink` | 1 | — | `ink` | `muted` |
| `focal` | `accent @ 0.07` | `accent` | 1.4 | — | `ink` | `accent` (line 1) + `muted` (line 2) |
| `external` | `var(--dd-node-white)` | `muted` | 1 | `4,3` | `ink` | `muted` |
...
**Recommended cross-type palette** (same as `type-medallion.md` / `type-process.md` / `type-dp-integration.md` / `type-matrix.md`):
...
| standard component fill | `var(--dd-node-white)` | `paper @ 0.04` |
